...
const server=createServer(async(req,res)=>{
 try{
  ...
  res.setHeader('Content-Type',extname(file)==='.png'?'image/png':'application/octet-stream');res.end(await readFile(file))
...
try{
 ...
 for(const viewport of [{width:844,height:390},{width:667,height:375},{width:568,height:320},{width:390,height:844},{width:320,height:568},{width:1280,height:800}]){
  ...
  await page.locator('[data-scmj-close-settings]').click()
