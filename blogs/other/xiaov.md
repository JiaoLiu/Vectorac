<div class="xiaov-page">

<div class="xiaov-hero">
  <div class="xiaov-hero-text">
    <div class="xiaov-eyebrow">桌面 AI 陪伴机器人</div>
    <h1 class="xiaov-title">小V</h1>
    <p class="xiaov-tagline">喊一声「你好，小V」，就陪你聊天的 AI 机器人</p>
    <p class="xiaov-desc">基于 ESP32-S3 开发，实时 AI 语音对话，本地唤醒、1.54 寸屏幕表情，还能放音乐、讲故事。</p>
    <div class="xiaov-hero-cta">
      <a class="demo-cta" href="https://vectorac.com/xiaov/account/" target="_blank" rel="noopener">进入小V控制台</a>
    </div>
  </div>
...
<div class="xiaov-capabilities">
  <div class="xiaov-capability-card">
    <div class="xiaov-capability-icon">👋</div>
    <h3>「你好，小V」本地唤醒</h3>
    <p>离线唤醒引擎跑在设备本地，无需联网，听到唤醒词立即回应。</p>
  </div>
  <div class="xiaov-capability-card">
    <div class="xiaov-capability-icon">💬</div>
    <h3>RTC 实时语音对话</h3>
    <p>低延迟多轮语音对话，说完就有回应，上下文连续、可追问。</p>
  </div>
  <div class="xiaov-capability-card">
    <div class="xiaov-capability-icon">🎵</div>
    <h3>放音乐、讲故事</h3>
    <p>HTTP 拉流 + MP3 解码播放，能当小音箱用；对话时自动暂停、说完自动恢复。</p>
  </div>
  <div class="xiaov-capability-card">
    <div class="xiaov-capability-icon">🖥</div>
    <h3>1.54 寸屏幕中文界面</h3>
    <p>ST7789 彩色屏显示时间、Wi-Fi、音量、电量，配网、聆听、思考、说话都有专属动画。</p>
  </div>
  <div class="xiaov-capability-card">
    <div class="xiaov-capability-icon">📶</div>
    <h3>局域网网页控制</h3>
    <p>同一 Wi-Fi 下，手机/电脑浏览器直接打开小V控制页，配对后就能开始对话、调音量、播音乐。</p>
  </div>
</div>
