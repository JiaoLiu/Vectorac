...
不是比谁的牌大，而是让每一手牌打出更高的分数。组合扑克、小丑牌与消耗牌，用「筹码 × 倍率」击破盲注，构筑能闯过 8 个底注的牌组。J、Q、K 使用与牌桌一致的新版双面人像牌面。
:::
...
- **看清牌面特效**：选中带增强、版本或蜡封的手牌，牌桌中央会短暂提示效果，约 2.5 秒后消失；重新选中可再次查看。待办清单等小丑条件仍显示本轮目标，满足条件时高亮。
